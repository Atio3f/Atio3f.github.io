let projets = {
    "TITANIC_BDD" : `
        <h2 class="TitreProjet">Analyse du naufrage du Titanic --> décembre 2024</h2>
        ...
        `,
    "CIRCUS_PLANNER" : `
        <h2 class="TitreProjet">Application lourde pour la gestion des cirques --> mars 2024</h2>
        ...
        `,
    "MONA" : `
        <h2 class="TitreProjet"> Application web d'évènements --> 2024-2025</h2>
    ...
    "TRI_DEPECHES" : `
        `,
    "FOC" : `
        <h2 class="TitreProjet"> Jeu 2d de stratégie tour par tour sur Godot --> 2024-...</h2>
        <h4> Langages utilisées : </h4>
        <p> Création d'un jeu vidéo avec 3 amis à partir d'un jeu de plateau créé au collège. Etant le seul programmeur, mon rôle est de réaliser le prototype sur Godot et en GDScript(qui est le langage utilisé sur Godot). Pour le moment, seul les unités ont été réalisées.</p>
        <br>
        ...
        <a href="https://github.com/Atio3f/FightOfCities2D">Lien Github vers le projet</a> <a href=""> Lien pour tester le projet </a>
        `,
    "NUTRISCORE" : `
        <h2 class="TitreProjet">Analyse du naufrage du Titanic --> décembre 2024</h2>
        `,
    "SITE_FICTIF_CGI" : `
        <h2 class="TitreProjet">Site fictif à destination de collégiens en recherche de stage pour leur présenter CGI --> décembre 2024</h2>
        `
